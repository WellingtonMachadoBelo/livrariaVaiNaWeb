     ...
     <header className={styles.boxHeader}>
      ...
      <nav >
        <ul className={styles.boxNav}>
            <li><Link to="/"  className={styles.text}>Início</Link></li>
            <li><Link to="/doados" className={styles.text}>Livros Doados</Link></li>
            <li><Link to="/queroDoar" className={styles.text}>Quero Doar</Link></li>
        </ul>
      </nav>
